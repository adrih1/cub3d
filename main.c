...
/*   Updated: 2024/10/28 08:41:43 by edouard          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_verify_extension(char *str)
{
	...
	last_dot_found++;
	if (str[last_dot_found] == 'c' && str[last_dot_found + 1] == 'u' && str[last_dot_found + 2] == 'b' && (str[last_dot_found + 3] == ' ' || str[last_dot_found + 3] == '\0'))
		return (0);
	else
		return (1);
}
